    ...
    <div id="page">
        ...
        <form class="form-register" action="Controlador" method="POST">
            ...
            <div class="contenedor-inputs">
                <input type="email" id="inputs" class="input-48" placeholder="Correo" name="txtcorreo" required>
                <input type="password" id="inputs" class="input-48" placeholder="Contrasena" name="txtcontrasena" required>
